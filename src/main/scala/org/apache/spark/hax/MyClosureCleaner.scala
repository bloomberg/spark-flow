...
/**
  ...
  */
object MyClosureCleaner  {

//  def logDebug(s: String) = {
//    println(s)
//  }
//
//  def logWarning(s: String) = {
//    println(s)
//  }
//
...
//        logDebug("getting classes: "+ cls.getName)
...
//        println(s"visiting method insn: op: $op, owner: $owner, name; $name, desc: $desc")
//        for (cl <- fields.keys if cl.getName == owner.replace('/', '.')) {
...
//              visitedMethods += m
//              MyClosureCleaner.getClassReader(cl).accept(
...
//    println(s"closure visit: myName: $myName, name: $name, superName: $superName")
//
//    myName = name
//  }
//
...
//      override def visitMethodInsn(
//                                    op: Int, owner: String, name: String, desc: String, itf: Boolean) {
//        println(s"closure visiting method insn: op: $op, owner: $owner, name: $name, desc: $desc")
//
